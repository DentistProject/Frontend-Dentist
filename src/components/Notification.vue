    ...
    <div class="m-3">
        <div class="mb-4">
            <div class="card">
                <div class="card-body text-white mailbox-widget pb-0" style="background-color: #567890">
                    <h2 class="text-white pb-3">Notification</h2>
                </div>
                    ...
                    <table class="table email-table no-wrap table-hover mb-0 font-14">
                        ...
                        <tbody>
                            <tr v-for="message in messages" :key="message.id">
                                ...
                                <td>
                                    <span class="mb-0 text-muted">{{ message.receiver }}</span>
                                </td>
                                <td>
                                ...
                                <td class="text-muted">{{ message.sentTime }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div v-if="showModal" class="modal" :style="{ display: showModal ? 'block' : 'none' }">
            <div class="modal-content">
                ...
                <p><strong>Sent Time:</strong> {{ selectedMessage.sentTime }}</p>
